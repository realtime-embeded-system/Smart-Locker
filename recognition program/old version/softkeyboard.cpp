    ...
    QWidget(parent),cursorGlobalPos(0,0),isMousePress(false)
{
    ...
    this->initKeysArea();
    this->selectKeyboardStyle(1);//选择皮肤
    this->setMoveEnabled();
...
void SoftKeyboard::initStyleSheet()
{
    ...
    keysAreaStyle.append(
                ".QWidget{background-color:#1E1E1E;font-size:25px;}"
                "QToolButton{background-color:#4E4E4E;color:#E6E6E6;border-radius:4px;font-size:25px;}"
                "QToolButton#specialKeyStyle{background-color:#2D2D2D;border-radius:2px;font-size:25px;}");
    //功能和候选区区域样式 目前与按键区域样式一致
    functionAndCandidateAreaStyle.append(
                "QWidget{background-color:#1E1E1E;color:#E6E6E6;font-size:25px;}"
                "QToolButton{border-style:none;font-size:25px;}"
                "QToolButton#pageBtn{font-weight:bold;font-size:25px;}"
                "QToolButton#pageBtn:disabled{color:#6c97b4;font-size:25px;}"
                "QLineEdit{background-color:#4E4E4E;font-size:25px;}");
    /*皮肤2:简白*/
    keysAreaStyle.append(
                ".QWidget{background-color:#D8D8D8;font-size:25px;}"
                "QToolButton{background-color:#FFFFFF;color:black;border-radius:6px;font-size:25px;}"
                "QToolButton#specialKeyStyle{background-color:#EBEBEB;border-radius:6px;font-size:25px;}");
    functionAndCandidateAreaStyle.append(
                "QWidget{background-color:#D8D8D8;color:black;font-size:25px;}"
                "QToolButton{border-style:none;font-size:25px;}"
                "QToolButton#pageBtn{font-weight:bold;font-size:25px;}"
                "QToolButton#pageBtn:disabled{color:#6c97b4;font-size:25px;}"
                "QLineEdit{background-color:white;font-size:25px;}");
    /*皮肤3:魅紫*/
    keysAreaStyle.append(
                ".QWidget{background-color:#190724;font-size:25px;}"
                "QToolButton{background-color:#272A5E;color:#68CBF2;border-radius:4px;font-size:25px;}"
                "QToolButton#specialKeyStyle{background-color:#241D48;border-radius:2px;font-size:25px;}");
    functionAndCandidateAreaStyle.append(
                "QWidget{background-color:#190724;color:#68CBF2;font-size:25px;}"
                "QToolButton{border-style:none;font-size:25px;}"
                "QToolButton#pageBtn{font-weight:bold;font-size:25px;}"
                "QToolButton#pageBtn:disabled{color:#6c97b4;font-size:25px;}"
                "QLineEdit{background-color:#272A5E;font-size:25px;}");
}
/*
